...
class MY_Model extends CI_Model {
    ...
    public function __construct()
    {
        ...
        if(!$this->table){
            $this->table = strtolower(
                // nama class diambil kemudian kata _model diganti dengan string kosong
    ...
    public function validate()
    {
        ...
        // fungsi getValidationRules diambil dari fungsi yang berada pada masing masing model berpa array
