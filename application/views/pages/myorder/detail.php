<main role="main" class="container">
	...
	<div class="row">
		<div class="col-md-3">
			<?php $this->load->view('templates/_menu'); ?>
		</div>
		<div class="col-md-9">
			<div class="card">
				<div class="card-header">
					...
					<div class="float-right">
						<?php $this->load->view('templates/_status', ['status' => $order->status]); ?>
					</div>
				</div>
				<div class="card-body">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								<td>
									<p><img src="<?= $row->image ? base_url("assets/image/product/$row->image") : base_url('/images/product/default.png') ?>" alt="" height="50"> <strong><?= $row->title ?></strong></p>
								</td>
			...
			<div class="row mb-3 mt-3">
				...
				<div class="card">
				<div class="card-body">
					<img src="<?= base_url("assets/image/confirm/$order_confirm->image") ?>" alt="" height="100">
				</div>
				</div>
				</div>
			</div>
