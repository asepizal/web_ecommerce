...
class Product extends MY_Controller 
{
    ...
    public function index($page=null)
    {
        ...
        $data['content']    = $this->product->select(
            ['product.id','product.title AS product_title', 'product.price','product.is_available','product.description','product.image','category.title AS category_title']
		...
		$data['pages']		= 'pages/product/index';
