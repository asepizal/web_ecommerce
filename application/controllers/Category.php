...
class Category extends MY_Controller {
	...
	public function index($page = null)
	{
		...
		// fungsi dibawah mengahasilkan query disetiap halaman , limit dan offsetnya diatur didalam fungsi paginate dengan halaman sebagai paramaeternya  
	...
	public function addCategory()
	{
		...
		if (!$this->category->validate()) {
			...
			$data['input']			= $input;
			$data['form_action']	= base_url('category/addCategory');
			$data['pages']			= 'pages/category/form';
